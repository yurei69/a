//gcc libencry.c   -static-libgcc -static-libstdc++ -static   -lsodium
...
#define   SALT   (const unsigned char *)"1234567890123456"
...
int
init_crypt(const char * Password)
{	
